    ...
    public sealed class CameraCompositionExplicitSubjectSelectionTests
    {
        ...
        private sealed class Fixture : IDisposable
        {
                ...
                bool attachDependencies = true)
            {
                ...
                Composition = new CameraPresentationRuntime("explicit-selection");
                Composition.Configure(
                    ...
                    new RuntimeScopeContext(
                        RuntimeContentOwner.Session(
                            "explicit-selection-session",
                            "explicit-selection-session"),
                        nameof(CameraCompositionExplicitSubjectSelectionTests),
                        "presentation-test"));
            ...
            internal void Activate() => Composition.SetEnabled(true);
