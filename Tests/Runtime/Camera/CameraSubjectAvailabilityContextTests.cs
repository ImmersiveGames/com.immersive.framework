...
namespace Immersive.Framework.Camera.Tests
{
    public sealed class CameraSubjectAvailabilityContextTests
    {
        ...
        {
            var context = new CameraSubjectAvailabilityContext("session-a");
        ...
        {
            var first = new CameraSubjectAvailabilityContext("session-a");
            var second = new CameraSubjectAvailabilityContext("session-b");
