...
## 5. Current IF-ADR-032 migration follow-up

The Local Multiplayer consumer has since been migrated from the historical
`CameraSharedComposition` topology recorded above to the current IF-ADR-032 model:

~~~text
GameApplication Camera Session
  -> explicit physical Output prefab
...
Current consumer evidence is recorded separately so this historical ADR-030 proof remains
an accurate description of the 2026-09-20 boundary:
