...
{
    internal static class ObjectResetGroupTriggerBinder
    {
        internal static ObjectResetGroupTriggerBinderResult TryBind(
            ...
            IResetSelectionExecutionRuntimePort resetSelectionExecutionRuntime)
        {
            ...
            {
                return ObjectResetGroupTriggerBinderResult.Rejected(
            ...
            if (triggers.Count == 0)
            {
                return ObjectResetGroupTriggerBinderResult.OptionalAbsent(rootCount);
            }
            ...
            return rejected > 0
                ? ObjectResetGroupTriggerBinderResult.Rejected(
                    ...
                    idempotent,
                    rejected)
                : ObjectResetGroupTriggerBinderResult.Completed(
                    rootCount,
                    triggers.Count,
                    bound,
                    idempotent);
