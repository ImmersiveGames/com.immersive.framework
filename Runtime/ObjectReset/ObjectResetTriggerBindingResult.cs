...
{
    internal readonly struct ObjectResetTriggerBindingResult
    {
        private ObjectResetTriggerBindingResult(
            bool succeeded,
            string status,
            string message,
            int rootCount,
        ...
        internal static ObjectResetTriggerBindingResult OptionalAbsent(int roots)
        {
            return new ObjectResetTriggerBindingResult(
                true,
                "OptionalAbsent",
        ...
        internal static ObjectResetTriggerBindingResult Completed(
            int roots,
            int triggers,
            int bound,
            int idempotent)
        ...
        internal static ObjectResetTriggerBindingResult Rejected(
            string status,
            string message,
            int roots,
            int triggers,
