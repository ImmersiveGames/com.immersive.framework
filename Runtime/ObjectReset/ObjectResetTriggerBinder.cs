...
{
    internal static class ObjectResetTriggerBinder
    {
        internal static ObjectResetTriggerBinderResult TryBind(
            ...
            IResetExecutionRuntimePort resetExecutionRuntime)
        {
            ...
            {
                return ObjectResetTriggerBinderResult.Rejected(
            ...
            if (triggers.Count == 0)
            {
                return ObjectResetTriggerBinderResult.OptionalAbsent(rootCount);
            }
            ...
            return rejected > 0
                ? ObjectResetTriggerBinderResult.Rejected(
                    ...
                    idempotent,
                    rejected)
                : ObjectResetTriggerBinderResult.Completed(
                    rootCount,
                    triggers.Count,
                    bound,
                    idempotent);
