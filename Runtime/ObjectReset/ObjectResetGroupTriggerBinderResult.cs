...
{
    internal readonly struct ObjectResetGroupTriggerBinderResult
    {
        private ObjectResetGroupTriggerBinderResult(
            bool succeeded,
            string status,
            string message,
            int rootCount,
        ...
        internal static ObjectResetGroupTriggerBinderResult OptionalAbsent(int roots)
        {
            return new ObjectResetGroupTriggerBinderResult(
                true,
                "OptionalAbsent",
        ...
        internal static ObjectResetGroupTriggerBinderResult Completed(
            int roots,
            int triggers,
            int bound,
            int idempotent)
        ...
        internal static ObjectResetGroupTriggerBinderResult Rejected(
            string status,
            string message,
            int roots,
            int triggers,
