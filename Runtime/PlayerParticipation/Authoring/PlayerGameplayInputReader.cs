...
namespace Immersive.Framework.PlayerParticipation
{
    ...
    public sealed class PlayerGameplayInputReader :
        MonoBehaviour, IPlayerGameplayInputReader
    {
        private const string UnboundDiagnostic =
            "Player gameplay input reader is not bound to a current Activity gameplay occurrence.";
            ...
            out string issue)
        {
            ...
            {
                issue =
                    "Player gameplay input reader requires the exact PlayerInput evidence already correlated to this Logical Actor.";
                return false;
            }
            ...
            {
                issue =
                    "Player gameplay input reader requires the exact gameplay Action Map from PlayerInput.actions.";
                return false;
            }
            ...
            out InputAction runtimeAction)
        {
            ...
            {
                _diagnostic =
                    "Player gameplay input reader requires an authored InputActionReference used as action identity.";
                return false;
            }
            ...
            out string issue)
        {
            ...
            {
                issue =
                    "Player gameplay input reader action resolution requires an authored InputActionReference used only as stable identity.";
                return false;
            }
            ...
            {
                issue =
                    "Player gameplay input reader action resolution requires the exact current gameplay Action Map from PlayerInput.actions.";
                return false;
            }
        ...
        private void OnDestroy()
        {
            ClearRuntimeState(true,
                "Player gameplay input reader was destroyed; previous Activity input authority is invalid.");
        }
    }
}
