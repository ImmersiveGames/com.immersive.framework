...
{
    internal static class LocalPlayerActorSelectionRequestAuthoringBinder
    {
        internal static LocalPlayerActorSelectionRequestAuthoringBinderResult TryBind(
            ...
            IPlayerActorSelectionRuntimePort selectionRuntime)
        {
            ...
            {
                return LocalPlayerActorSelectionRequestAuthoringBinderResult.OptionalAbsent(
                    rootCount);
            }
            ...
            return LocalPlayerActorSelectionRequestAuthoringBinderResult.Completed(
                rootCount,
                authorings.Count,
                pendingBound,
                idempotent);
