...
namespace Immersive.Framework.PlayerParticipation
{
    ...
    [AddComponentMenu("Immersive Framework/Player/Player Provisioning Status Binding")]
    [FrameworkApiStatus(
        FrameworkApiStatus.Experimental,
        "IF-PLAYER-SURFACE-06 read-only designer status and diagnostics binding.")]
    public sealed class PlayerProvisioningStatusBinding : MonoBehaviour
    {
        [SerializeField]
        ...
        private PlayerProvisioningCommandTrigger commandTrigger;

        public LocalPlayerProvisioningConsumerAccessBinding ConsumerAccessBinding =>
            consumerAccessBinding;

        public PlayerProvisioningCommandTrigger CommandTrigger => commandTrigger;
        ...
        public string Diagnostic
        {
            get
            {
                ...
                return consumerAccessBinding != null
                    ...
                    : "Player Provisioning Status Binding requires an explicit Local Player Provisioning Consumer Access binding.";
            }
        }
        ...
        public string LastOperationSummary => commandTrigger != null
            ...
            : "No Player Provisioning Command Trigger is explicitly linked, so this binding has no Last Operation source.";
        ...
        public bool TryValidateConfiguration(out string issue)
        {
            ...
            {
                issue =
                    "Player Provisioning Status Binding requires a binding with an explicit Route or Activity scope.";
                return false;
            }
            ...
            {
                issue =
                    "The optional Player Provisioning Command Trigger must use this same Consumer Access Binding; otherwise Last Operation could describe a different scope.";
                return false;
            }
