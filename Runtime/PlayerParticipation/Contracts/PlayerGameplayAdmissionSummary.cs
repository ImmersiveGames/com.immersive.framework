...
namespace Immersive.Framework.PlayerParticipation
{
    ...
    public readonly struct PlayerGameplayAdmissionSummary
    {
        ...
        public string ToDiagnosticString() =>
            $"session='{SessionContextId}' slot='{PlayerSlotId.StableText}' " +
            $"state='{State}' admission='{Token.StableText}' " +
            $"occupancy='{OccupancyToken.StableText}' input='{InputBindingToken.StableText}'";
