...
namespace Immersive.Framework.PlayerParticipation
{
    ...
    internal sealed class PlayerGameplayCameraEligibilityRuntimeContext
    {
        ...
        internal PlayerGameplayCameraEligibilityResult TryConfirmEligibility(PlayerActorPreparationSummary preparation, PlayerGameplayOccupancySummary ignoredOccupancy, PlayerGameplayInputBindingSummary ignoredInput, CameraOutputAuthoring outputSession, PlayerActorDeclaration actor, PlayerGameplayCameraAuthoring authoring, string source, string reason)
        {
        ...
        internal PlayerGameplayCameraEligibilityResult TrySkipOptional(PlayerActorPreparationSummary preparation, PlayerGameplayOccupancySummary ignoredOccupancy, PlayerGameplayInputBindingSummary ignoredInput, CameraOutputAuthoring outputSession, PlayerGameplayCameraRequiredness requiredness, string source, string reason)
        {
        ...
        private static bool TryGetOutput(CameraOutputAuthoring binding,out CameraOutputSession output,out string issue) { output=null; issue=string.Empty; return binding!=null && binding.TryGetSession(out output,out issue); }
