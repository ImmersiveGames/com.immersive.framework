...
namespace Immersive.Framework.PlayerParticipation
{
    internal sealed class ActivityPlayerRelocationContextRuntime : IActivityPlayerLifecycleAdmissionRuntime
    {
        ...
        internal ActivityPlayerRelocationContextRuntime(PlayerActorPreparationRuntimeHostModule module) => preparationModule = module;
        ...
        {
            if (preparationModule == null) { issue = "Player Actor preparation runtime is unavailable for Activity relocation."; return false; }
            return preparationModule.TryConfigureActivityRelocationContext(context, out issue);
        }
