...
namespace Immersive.Framework.Camera
{
    ...
    internal sealed class CameraPresentationMaterializationRuntime
    {
        ...
        internal CameraPresentationMaterializationResult ReleaseTerminal(
            ...
            string reason)
        {
            ...
            string resolvedReason =
                reason.NormalizeTextOrFallback(
                    "camera-presentation-terminal-release");
            ...
            if (handle == null)
            {
                return CameraPresentationMaterializationResult.Failure(
                    CameraPresentationMaterializationStatus
                        .RejectedInvalidContext,
                    "Camera Presentation terminal release requires an explicit materialization handle.");
            }
            ...
            handle.PresentationRuntime.DisposeTerminal();
