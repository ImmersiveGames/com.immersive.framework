...
namespace Immersive.Framework.Camera
{
    ...
    public sealed class RouteCameraOverride : ScopedCameraOverride, IRouteContentLifecycleReceiver
    {
        ...
        private bool TryValidateContext(RouteContentLifecycleContext context, out string diagnostic)
        {
            ...
            if (context.Route == null || !ReferenceEquals(context.Route, assignedRoute)) { diagnostic = "Route camera override lifecycle owner does not match the assigned Route asset reference."; return false; }
            return true;
        }
    }
}
