...
namespace Immersive.Framework.Camera
{
    ...
    public abstract class ScopedCameraOverride : MonoBehaviour, ICameraOutputSessionConsumer
    {
        ...
        private CameraOutputAuthoring _outputSession;
        ...
        public CameraOutputAuthoring OutputSession => _outputSession;
        ...
        void ICameraOutputSessionConsumer.AttachOutputSession(CameraOutputAuthoring binding)
        {
