...
{
    [CustomEditor(typeof(PlayerSessionCommandTrigger))]
    internal sealed class PlayerSessionCommandTriggerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var trigger = (PlayerSessionCommandTrigger)target;

            FrameworkAuthoringInspectorGui.ProductHeader(
                "Player Session Command Trigger",
        ...
        private void DrawActions(PlayerSessionCommandTrigger trigger)
        {
