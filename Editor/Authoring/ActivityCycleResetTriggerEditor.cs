...
namespace Immersive.Framework.Editor.Authoring
{
    ...
    internal sealed class ActivityCycleResetTriggerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            FrameworkAuthoringInspectorGui.ProductHeader("Activity Cycle Reset Trigger", string.Empty);
            ...
            {
                var trigger = (ActivityCycleResetTrigger)target;
                FrameworkAuthoringInspectorGui.RuntimeBinding(
                    trigger.ActivityCycleResetRuntimeBindingStatus,
                    trigger.ActivityCycleResetRuntimeBindingDiagnostic,
