...
namespace Immersive.Framework.Editor.CameraAuthoring
{
    public static class CameraDefinitionIdentityEditorUtility
    {
        ...
        public static string Validate(ScriptableObject definition)
        {
            ...
            bool valid = definition is CameraViewDefinition view
                ? view.HasValidId : ((CameraOutputDefinition)definition).HasValidId;
        ...
        private static SerializedObject SerializedDefinition(ScriptableObject definition)
        {
            ...
            if (!(definition is CameraViewDefinition) && !(definition is CameraOutputDefinition))
                throw new ArgumentException("Expected a typed Camera definition.", nameof(definition));
