...
namespace Immersive.Framework.Editor.PlayerAuthoring
{
    ...
    public sealed class PlayerComposerEditor : UnityEditor.Editor
    {
        ...
        private void ValidateOnly()
        {
            ...
            composer.EditorSetApplyRebuildResult("ValidationSucceeded", string.Empty, "Validation completed. No materialization was changed.");
            EditorUtility.SetDirty(composer);
        ...
        private void ApplyOrRebuild()
        {
            ...
            Transform bindingsRoot = EnsureBindingsRoot(composer, report);
            Transform cameraTarget = EnsureAnchor(composer, "CameraTarget", report);
            Transform lookAtTarget = EnsureAnchor(composer, "LookAtTarget", report);

            composer.EditorSetGeneratedReferences(bindingsRoot, cameraTarget, lookAtTarget);
            serializedObject.Update();

            Component actorDeclaration = EnsureComponent(composer.gameObject, "Immersive.Framework.Actors.PlayerActorDeclaration", "PlayerActorDeclaration", true, report, component =>
            {
                bool changed = false;
                changed |= SetSerialized(component, "actorId", composer.ActorId);
                changed |= SetSerialized(component, "displayName", composer.name);
                changed |= SetSerialized(component, "playerInput", _playerInput.objectReferenceValue);
                changed |= SetSerialized(component, "reason", "player-composer.apply");
                return changed;
            });

            Component slotDeclaration = EnsureComponent(composer.gameObject, "Immersive.Framework.PlayerSlots.PlayerSlotDeclaration", "PlayerSlotDeclaration", true, report, component =>
            {
                bool changed = false;
            ...
            EnsureOptionalRootComponent(composer, "UnityPlayerInputGateAdapter", report, component =>
            {
                bool changed = false;
                changed |= SetSerialized(component, "playerInput", _playerInput.objectReferenceValue);
            ...
            {
                EnsureOptionalRootComponent(composer, "UnityResetSubjectAdapter", report, component =>
                {
                    bool changed = false;
            ...
            EnsureBindingComponent(bindingsRoot, "Immersive.Framework.PlayerBinding.PlayerControlBindingTargetBehaviour", "PlayerControlBindingTargetBehaviour", true, report, component =>
            {
                return SetSerialized(component, "bindingTargetName", "Player Control Binding Target");
            });

            EnsureBindingComponent(bindingsRoot, "Immersive.Framework.PlayerBinding.UnityPlayerInputBridgeTargetBehaviour", "UnityPlayerInputBridgeTargetBehaviour", true, report, component =>
            {
                bool changed = false;
            ...
            EnsureBindingComponent(bindingsRoot, "Immersive.Framework.PlayerBinding.UnityPlayerInputActivationTargetBehaviour", "UnityPlayerInputActivationTargetBehaviour", true, report, component =>
            {
                bool changed = false;
            ...
            {
                EnsureBindingComponent(bindingsRoot, "Immersive.Framework.PlayerSlots.PlayerSlotOccupancy", "PlayerSlotOccupancy", true, report, component =>
                {
                    bool changed = false;
            ...
            {
                EnsureBindingComponent(bindingsRoot, null, "FrameworkCameraAnchorHost", false, report, component =>
                {
                    bool changed = false;
                    changed |= SetSerialized(component, "trackingTarget", _cameraTarget.objectReferenceValue != null ? _cameraTarget.objectReferenceValue : cameraTarget);
                    changed |= SetSerialized(component, "lookAtTarget", _lookAtTarget.objectReferenceValue != null ? _lookAtTarget.objectReferenceValue : lookAtTarget);
                    return changed;
                });
            }
            else
            ...
            {
                EnsureBindingComponent(bindingsRoot, "Immersive.Framework.Reset.Unity.UnityTransformResetParticipant", "UnityTransformResetParticipant", true, report, component =>
                {
            ...
            if (composer.LogApplyRebuildDiagnostics)
            {
